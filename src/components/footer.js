...
function Footer() {
    return ( <>
        ...
        <footer class="text-center text-lg-start bg-white text-muted" style={{ marginTop: 60, backgroundColor:"#f7f7f7"}}>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                            ...
                            <h6 class="text-uppercase fw-bold mb-4">
                                <i class="fas fa-gem me-3 text-secondary"></i>ResumePro
                            </h6>
                            <p>

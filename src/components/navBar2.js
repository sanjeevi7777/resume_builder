...
const NavBar = () => {
    ...
    return (
        <div className='nav'>
            ...
            <h3 style={{ color: 'black', paddingTop: 8, marginLeft: 15, fontFamily: 'fantasy', fontStyle: 'italic', fontSize: 30 }}> Resume<span style={{ color: 'teal', fontSize: 30 }}>Pro</span><span style={{ color: 'teal',fontSize: 30 }}>.io</span></h3>
            <div>
                <ul>
                    {/* <li className='li'>
            ...
            <div className='user'>
                <ul>
                    <li className='navButtons'>
                        <Link to="/login" style={{ paddingBottom: 10 ,color:'teal'}} className='navButton'>Log In</Link>
                    </li>
                    ...
                    <div className='proicon'>
                        <Popover>
                            ...
                            <PopoverContent color='white' bg='white' borderColor='gray.300' width='200px' height='300px' margin='5'>
                                ...
                                <>
                                    <Button colorScheme='red' onClick={onOpen} style={{ width: 100, alignSelf: 'center' }}>Logout ?</Button>
                                    <AlertDialog
